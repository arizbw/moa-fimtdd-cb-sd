...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static double computeBennettBound(double variance, double confidence, double n) {
        return Math.sqrt(Math.log(1.0 / confidence)*(2*variance + 2/3)/n);
        		//Math.sqrt(Math.log(1.0 / confidence)*(2*variance)+(2/3)))/n)));
    }
    ...
    public static double computeMcdiarmidBound(double range, double confidence,
            double n) {
        return Math.sqrt(((range*range) * Math.log(1.0 / confidence))
                / (2.0 * n));
    }
    public static double computeChernoffBound( double sum, double range, double confidence) {
    	return Math.sqrt(range*(Math.log(2.0 / confidence))/ sum);
    }
